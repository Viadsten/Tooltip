...
/* harmony import */ var _modules_tooltip_init_tooltip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/tooltip/init-tooltip */ "./js/modules/tooltip/init-tooltip.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_tooltip_init_tooltip__WEBPACK_IMPORTED_MODULE_4__["initTooltip"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/tooltip/calculate-position.js":
/*!**************************************************!*\
  !*** ./js/modules/tooltip/calculate-position.js ***!
  \**************************************************/
/*! exports provided: calculateTooltipPosition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateTooltipPosition", function() { return calculateTooltipPosition; });
var SAFE_HORIZONTAL_DISTANCE = 15;
var tooltipPosition = {
  LEFT: 'left',
  CENTER: 'center',
  RIGHT: 'right',
...
var checkHorizontalPosition = function checkHorizontalPosition(trigRect, toolRect, args) {
...
var checkVerticalPosition = function checkVerticalPosition(trigRect, toolRect) {
...
var calculateTooltipPosition = function calculateTooltipPosition(trigger, tooltip, arrow, content, args) {
  ...
  var tooltipCord = {};
  var arrowCord = {}; // TODO стоит вынести switch'и в отдельные функции
  // vertical
  ...
  tooltip.style.transform = "translate3d(".concat(tooltipCord.x, "px, ").concat(tooltipCord.y, "px, 0)");
  arrow.style.transform = "translate3d(".concat(arrowCord.x, "px, ").concat(arrowCord.y, ", 0)");
};
...
/***/ "./js/modules/tooltip/init-tooltip.js":
/*!********************************************!*\
  !*** ./js/modules/tooltip/init-tooltip.js ***!
  \********************************************/
/*! exports provided: initTooltip, tooltips */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _tooltip__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tooltip */ "./js/modules/tooltip/tooltip.js");
...
var initTooltip = function initTooltip() {
  ...
  if (tooltipTriggers) {
    tooltips = new _tooltip__WEBPACK_IMPORTED_MODULE_0__["Tooltips"](tooltipTriggers, settings);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Tooltips", function() { return Tooltips; });
/* harmony import */ var _calculate_position__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./calculate-position */ "./js/modules/tooltip/calculate-position.js");
...
var textTemplate = function textTemplate(text) {
  return "\n    <p class=\"tooltip__text\">".concat(text, "</p>\n  ");
};

var baseTemplate = function baseTemplate(content, args) {
  return "\n    <div class=\"tooltip\">\n      <div class=\"tooltip__content ".concat(args.mod ? 'tooltip__content--' + args.mod : '', "\">\n        ").concat(content, "\n        <div class=\"tooltip__mark\"></div>\n      </div>\n    </div>\n  ");
};

var body = document.querySelector('body');

var Tooltip = /*#__PURE__*/function () {
  function Tooltip(trigger, args) {
  ...
  _createClass(Tooltip, [{
    ...
    key: "checkContent",
    value: function checkContent(trigger) {
      switch ('string') {
        case _typeof(trigger.dataset.text):
          return textTemplate(trigger.dataset.text);

        case _typeof(trigger.dataset.html):
          return trigger.dataset.html;

        case _typeof(this.args.template):
    ...
    value: function show() {
      ...
      this.updatePosition();
      this.contentNode.classList.add(this.args.animation); // без таймаута css анимация отрабатывает некорректно

      setTimeout(function () {
        _this.contentNode.style.transitionDuration = _this.args.duration + 'ms';

        _this.contentNode.classList.add('is-shown');
      });
    }
  }, {
    key: "updatePosition",
    value: function updatePosition() {
      Object(_calculate_position__WEBPACK_IMPORTED_MODULE_0__["calculateTooltipPosition"])(this.trigger, this.tooltip, this.arrow, this.contentNode, this.args);
    }
  }, {
    key: "hide",
    value: function hide() {
    ...
    value: function render() {
      ...
      this.contentNode.style.maxWidth = "calc(100vw - ".concat(this.args.safePadding * 2, "px)");
...
var Tooltips = /*#__PURE__*/function () {
  function Tooltips(selector, args) {
    _classCallCheck(this, Tooltips);

    this.triggers = selector.length ? _toConsumableArray(selector) : [selector];
  ...
  _createClass(Tooltips, [{
    ...
    value: function init() {
      ...
      this.triggers.forEach(function (trigger) {
        _this2.getSettings(trigger);

        var tooltip = new Tooltip(trigger, _this2.getSettings(trigger));

        _this2.tooltips.push(tooltip);

        if (tooltip.args.click) {
          _this2.clickHandler = true;
        }
      });
    ...
    key: "getSettings",
    value: function getSettings(trigger) {
      var tooltipKey = trigger.dataset.tooltip;
      ...
      var settings = {};
      settings.animation = typeof this.settings[tooltipKey].animation === 'string' ? this.settings[tooltipKey].animation : this.defaultSettings.animation;
      settings.duration = typeof this.settings[tooltipKey].duration === 'number' ? this.settings[tooltipKey].duration : this.defaultSettings.duration;
      settings.safePadding = typeof this.settings[tooltipKey].safePadding === 'number' ? this.settings[tooltipKey].safePadding : this.defaultSettings.safePadding;
      settings.dev = typeof this.settings[tooltipKey].dev === 'boolean' ? this.settings[tooltipKey].dev : this.defaultSettings.dev;
      settings.click = typeof this.settings[tooltipKey].click === 'boolean' ? this.settings[tooltipKey].click : this.defaultSettings.click;
      settings.mod = typeof this.settings[tooltipKey].mod === 'string' ? this.settings[tooltipKey].mod : this.defaultSettings.mod;
      settings.template = typeof this.settings[tooltipKey].template === 'string' ? this.settings[tooltipKey].template : this.defaultSettings.template;
      return settings;
    }
  }, {
    key: "setUpdateOnScroll",
    value: function setUpdateOnScroll() {}
  }, {
    key: "setClickListener",
    value: function setClickListener() {
